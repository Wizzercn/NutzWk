package cn.wizzer.modules.controllers.back.cms;
...
import cn.wizzer.modules.services.cms.CmsChannelService;
...
public class CmsChannelController {
    ...
    @At
    @Ok("beetl:/private/cms/channel/add.html")
    @RequiresAuthentication
    ...
    @At("/edit/?")
    @Ok("beetl:/private/cms/channel/edit.html")
    @RequiresAuthentication
    ...
    public Object editDo(@Param("..") Cms_channel channel, HttpServletRequest req) {
        try {
            channel.setOpBy(Strings.sNull(req.getAttribute("uid")));
    ...
    @At("/child/?")
    @Ok("beetl:/private/cms/channel/child.html")
    @RequiresAuthentication
    ...
    @At
    @Ok("beetl:/private/cms/channel/sort.html")
    @RequiresAuthentication
