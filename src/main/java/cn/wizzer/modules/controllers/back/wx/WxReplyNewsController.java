package cn.wizzer.modules.controllers.back.wx;
...
public class WxReplyNewsController {
    ...
    @At("")
    @Ok("beetl:/private/wx/reply/news/index.html")
    ...
    @At
    @Ok("beetl:/private/wx/reply/news/add.html")
    @RequiresAuthentication
    public void add() {
    ...
    @At("/edit/?")
    @Ok("beetl:/private/wx/reply/news/edit.html")
    @RequiresAuthentication
