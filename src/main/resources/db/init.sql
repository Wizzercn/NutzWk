...
/* insertSysMenu21 */
insert into `sys_menu` (`id`, `parentId`, `path`, `name`, `aliasName`, `type`, `href`, `target`, `icon`, `isShow`, `disabled`, `permission`, `note`, `location`, `hasChildren`, `opBy`, `opAt`, `delFlag`) values('2cb327ad59b140828fd26eb2a46cb948','4cd8e4e9519e4cff95465194fdcc8d88','000200030003','关注自动回复','Follow','menu','/private/wx/reply/conf?type=follow','data-pjax','','1','0','wx.reply.follow',NULL,'9','0','','1467472280','0');
/* insertSysMenu22 */
...
/* insertSysMenu25 */
insert into `sys_menu` (`id`, `parentId`, `path`, `name`, `aliasName`, `type`, `href`, `target`, `icon`, `isShow`, `disabled`, `permission`, `note`, `location`, `hasChildren`, `opBy`, `opAt`, `delFlag`) values('0706112ff5dc46e388064a99bcdb0561','4cd8e4e9519e4cff95465194fdcc8d88','000200030004','关键词回复','Keyword','menu','/private/wx/reply/conf?type=keyword','data-pjax','','1','0','wx.reply.keyword',NULL,'10','0','','1467472362','0');
/* insertSysMenu26 */
