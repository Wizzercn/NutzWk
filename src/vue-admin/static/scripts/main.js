...
var SublimeApp = function () {
  ...
  function initToggleSidebar() {
    $(document).on("click", ".toggle-sidebar", function (e) {
      ...
      if (app.hasClass("small-menu")) {
        ...
        jQuery.post(vue+"/platform/login/layout", {p:"sidebar",v:false});
        ...
        jQuery.post(vue+"/platform/login/layout", {p:"sidebar",v:true});
      }
    });
  }
  ...
  function initToggleBoxed() {
    $(document).on("click", ".toggle-boxed", function (e) {
      if(app.hasClass("boxed")){
        ...
        jQuery.post(vue+"/platform/login/layout", {p:"boxed",v:false});
      }else{
        app.addClass("boxed");
        jQuery.post(vue+"/platform/login/layout", {p:"boxed",v:true});
      }
      e.preventDefault();
      e.stopPropagation();
    });
  ...
  function initToggleScroll() {
    $(document).on("click", ".toggle-scroll", function (e) {
      if(app.hasClass("fixed-scroll")){
        ...
        jQuery.post(vue+"/platform/login/layout", {p:"scroll",v:false});
      }else{
        app.addClass("fixed-scroll");
        jQuery.post(vue+"/platform/login/layout", {p:"scroll",v:true});
      }
      e.preventDefault();
      e.stopPropagation();
    });
  ...
  return {
    ...
    changeTheme:function(obj){
      jQuery.post(vue+"/platform/login/theme", {loginTheme:obj});
    },
