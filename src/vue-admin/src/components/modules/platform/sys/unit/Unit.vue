    ...
    <div>
      <header class="header navbar bg-white shadow">
        <div class="btn-group tool-button">
          <a class="btn btn-primary navbar-btn" v-link="{path:'/platform/sys/unit/add'}"><i class="ti-plus"></i>新建单位</a>
        </div>
      </header>
                  ...
                  <td>
                    <div class="btn-group">
                      ...
                      <ul class="dropdown-menu" role="menu">
                        <li><a href="${base}/private/sys/unit/detail/${o.id}" data-toggle="modal"
