...
ORYX.CONFIG.PLUGINS_CONFIG =				ACTIVITI.CONFIG.contextRoot +"editor-app/plugins.xml";
...
ORYX.Core.StencilSet.StencilSet = Clazz.extend({
    ...
    construct: function(source, modelMetaData, editorId){
		...
		if(ORYX.CONFIG.BACKEND_SWITCH) {
			this._baseUrl = ACTIVITI.CONFIG.contextRoot+"editor/stencilsets/bpmn2.0/";
			this._source = ACTIVITI.CONFIG.contextRoot+"stencilsets/bpmn2.0/bpmn2.0.json";
			
			new Ajax.Request(ACTIVITI.CONFIG.contextRoot + 'platform/wf/cfg/model/editor/stencilset?version=' + Date.now(), {
	            asynchronous: false,
	            method: 'get',
