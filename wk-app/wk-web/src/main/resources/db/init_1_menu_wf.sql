...
/* wf14 */
insert into sys_menu (id, parentId, path, name, aliasName, type, href, target, icon, isShow, disabled, permission, note, location, hasChildren, opBy, opAt, delFlag) values('6c76a3347fa74089a0586012a4200eb7','b4ccefa459d04250b4453334a33cc750','0004000100010001','分类管理',NULL,'menu','/platform/wf/cfg/category','data-pjax','','1','0','wf.cfg.category',NULL,'53','0','','1504680853','0')